...
/**
 * Defines the 'icon_picker' field widget.
 *
 * @FieldWidget(
 *   id = "icon_picker",
...
class IconPickerWidget extends WidgetBase {
  ...
  public function formElement(FieldItemListInterface $items, $delta, array $element, array &$form, FormStateInterface $form_state) {
    ...
    foreach ($icons as $icon) {
      // Optional: Cleanup the label.
      $label = str_replace('demo-icon-', '', $icon);
      $options[$icon] = ucfirst($label);
    }
    ...
    $element['value'] = [
      ...
      '#title' => t('Icon'),
      '#options' => $options,
      '#empty_option' => '- Please pick an icon -',
      '#attributes' => [
        'class' => ['icon-picker'],
      ],
    ...
    // Add library.
    $element['#attached']['library'][] = 'icon_picker/admin';
